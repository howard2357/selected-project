...
public class Register extends JFrame {
	...
	Socket socket;
	private BufferedReader in = null; // 輸入流
	private PrintStream out = null; // 輸出流
	...
	public void init()
	{
        ...
        timeType.setFont(new Font("宋體",Font.PLAIN,16));
        ...
        timeType.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				// TODO Auto-generated method stub
				type= Objects.requireNonNull(timeType.getSelectedItem()).toString();
			}
		});
