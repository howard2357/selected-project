...
public class SaveChat extends JDialog {
    ...
    public void init() {
        ...
        jl.setFont(new Font("楷體", Font.BOLD, 17));
        jl.setForeground(Color.WHITE);
        jl.setBounds(5, 3, 100, 25);
        jp.add(jl);
        jb.setBackground(Color.WHITE);
        jb.setForeground(Color.BLACK);
        jb.setFont(new Font("楷體", Font.PLAIN, 14));
        ...
        jp.add(jb);
        jsave.setEditable(false);
        jsave.setLineWrap(true);
        jsave.setFont(new Font("黑體", Font.PLAIN, 15));
