...
public class CheckQQ extends JFrame {
    ...
    JLabel jLtext1 = new JLabel("申請成功");
    JLabel jLtext2 = new JLabel("您獲得號碼：");
    JLabel jLqq = new JLabel();
    JButton jBenter = new JButton("登入We_Talk");
